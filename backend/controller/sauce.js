...
exports.statusLike = (req, res, next) => {
    ...
    Sauce.findOne({
        ...
        .then(sauceLikes => {
            ...
            if (!sauceLikes.usersLiked.includes(req.body.userId) && req.body.like === 1) {
            ...
            if (!sauceLikes.usersDisliked.includes(req.body.userId) && req.body.like === -1) {
                // mise à jour de la collection MongoDB
                Sauce.updateOne({
                        _id: req.params.id
                    }, {
            ...
            if (sauceLikes.usersLiked.includes(req.body.userId) && req.body.like === 0) {
                // mise à jour de la collection MongoDB
                Sauce.updateOne({
                        _id: req.params.id
                    }, {
            ...
            if (sauceLikes.usersDisliked.includes(req.body.userId) && req.body.like === 0) {
                // mise à jour de la collection MongoDB
                Sauce.updateOne({
                        _id: req.params.id
                    }, {
